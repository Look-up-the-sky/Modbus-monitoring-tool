...
void LoginDialog::on_pushButton_clicked()   //注册按钮
{
    if(ui->comboBox_2->currentText() == "Chinese")
    {
        Language = 0;
    ...
    RegisterDialog_k = new RegisterDialog;
    RegisterDialog_k->show();
    this->hide();
    connect(RegisterDialog_k,&RegisterDialog::Send_Close_Signal,this,&LoginDialog::show);
    connect(RegisterDialog_k,&RegisterDialog::Send_Close_Signal,this,&LoginDialog::GetAllDbName);
}
